...
vaultent server -log-level=trace -config /Users/sam/Deployments/HashiCorp/Vault/vault_ent/vault-config5.hcl
...
# Unseal Key 1: xs8Aeb7LW5V3aoSukokqNypqFEVFwPqZGcLJmVA0On8=
# Initial Root Token: s.Tmn1jfLaXDAKEDKl3qRZlFKV
 
#Use this command to unseal the Vault
vaultent operator unseal xs8Aeb7LW5V3aoSukokqNypqFEVFwPqZGcLJmVA0On8=
 
#Use this command to log into Vault as Root
vaultent login s.Tmn1jfLaXDAKEDKl3qRZlFKV
