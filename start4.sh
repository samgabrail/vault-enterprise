...
vaultent server -log-level=trace -config /Users/sam/Deployments/HashiCorp/Vault/vault_ent/vault-config4.hcl
...
# Unseal Key 1: DW+xJFrQHZ6SFkWavH4YFuyo/RqOWehZdxRqL/LR6dk=
# Initial Root Token: s.9rKUmK7e0X8Svglfki5nwJGx
 
#Use this command to unseal the Vault
vaultent operator unseal DW+xJFrQHZ6SFkWavH4YFuyo/RqOWehZdxRqL/LR6dk=

#Use this command to log into Vault as Root
vaultent login s.9rKUmK7e0X8Svglfki5nwJGx
