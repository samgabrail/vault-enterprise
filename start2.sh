...
vaultent server -log-level=trace -config /Users/sam/Deployments/HashiCorp/Vault/vault_ent/vault-config2.hcl
...
# Unseal Key 1: tjTTwsbS3OWle8nz3UcfA0GNehX9GKos9tBESgpLX7s=
# Initial Root Token: s.22YYNM5obtAKagj94IgPUrGN
 
#Use this command to unseal the Vault
vaultent operator unseal tjTTwsbS3OWle8nz3UcfA0GNehX9GKos9tBESgpLX7s=
 
#Use this command to log into Vault as Root
vaultent login s.22YYNM5obtAKagj94IgPUrGN
